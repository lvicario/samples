$(document).ready(function() {
	...
	$("ul#menu-main-nav li .sub-menu").css({'opacity':'0'});
	$("ul#menu-main-nav li").hoverIntent(config);
	
	$("ul#menu-aci-nav li .sub-menu").css({'opacity':'0'});
	$("ul#menu-aci-nav li").hoverIntent(config);
